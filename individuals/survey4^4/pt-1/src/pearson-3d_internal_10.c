...
#pragma omp for collapse(3)
    ...
    Formura_subroutine_2 (2, 24, 0, 37, 0, 260, Rsc0, -1, 1, 1, Rsc1, -1, 1, 1,
...
#pragma omp parallel
  {
    Formura_subroutine_0 (2, 24, 0, 37, 0, 260, Rsc1, -1, 1, 1, Rsc0, -1, 1, 1,
...
#pragma omp for collapse(3)
    ...
    Formura_subroutine_3 (46, 60, -6, 35, 258, 506, Rsc1, -45, 7, -257, Rsc0,
      -45, 7, -257, Rsc1, -44, 7, -257, Rsc1, -46, 7, -257, Rsc1, -45, 8, -257,
      Rsc1, -45, 6, -257, Rsc1, -45, 7, -256, Rsc1, -45, 7, -258, 8, 8, 8);
...
#pragma omp parallel
  {
    Formura_subroutine_1 (46, 60, -6, 35, 258, 506, Rsc0, -45, 7, -257, Rsc1,
      -45, 7, -257, Rsc0, -44, 7, -257, Rsc0, -46, 7, -257, Rsc0, -45, 8, -257,
      Rsc0, -45, 6, -257, Rsc0, -45, 7, -256, Rsc0, -45, 7, -258, 8, 8, 8);
...
#pragma omp parallel
  {
    Formura_subroutine_4 (0, 22, 2, 29, 0, 262, 17, -1, 251, 17, -1, 251, 18,
...
#pragma omp parallel
  {
    Formura_subroutine_5 (0, 22, 2, 29, 0, 262, 17, -1, 251, 17, -1, 251, 18,
      -1, 251, 16, -1, 251, 17, 0, 251, 17, -2, 251, 17, -1, 252, 17, -1, 250,
      Rsc1);
...
#pragma omp for collapse(3)
    ...
    Formura_subroutine_2 (0, 22, 2, 31, 0, 260, Rsc0, 1, -1, 1, Rsc1, 1, -1, 1,
      Rsc0, 2, -1, 1, Rsc0, 0, -1, 1, Rsc0, 1, 0, 1, Rsc0, 1, -2, 1, Rsc0, 1,
      -1, 2, Rsc0, 1, -1, 0, Rsc2);
...
#pragma omp parallel
  {
    Formura_subroutine_0 (0, 22, 2, 31, 0, 260, Rsc1, 1, -1, 1, Rsc0, 1, -1, 1,
      Rsc1, 2, -1, 1, Rsc1, 0, -1, 1, Rsc1, 1, 0, 1, Rsc1, 1, -2, 1, Rsc1, 1,
      -1, 2, Rsc1, 1, -1, 0, Rsc3);
...
#pragma omp for collapse(3)
    ...
    Formura_subroutine_2 (0, 22, 2, 33, 0, 258, Rsc2, 1, -1, 1, Rsc3, 1, -1, 1,
      Rsc2, 2, -1, 1, Rsc2, 0, -1, 1, Rsc2, 1, 0, 1, Rsc2, 1, -2, 1, Rsc2, 1,
      -1, 2, Rsc2, 1, -1, 0, Rsc1);
...
#pragma omp parallel
  {
    Formura_subroutine_0 (0, 22, 2, 33, 0, 258, Rsc3, 1, -1, 1, Rsc2, 1, -1, 1,
      Rsc3, 2, -1, 1, Rsc3, 0, -1, 1, Rsc3, 1, 0, 1, Rsc3, 1, -2, 1, Rsc3, 1,
      -1, 2, Rsc3, 1, -1, 0, Rsc0);
...
#pragma omp for collapse(3)
    ...
    Formura_subroutine_2 (2, 24, 0, 35, 0, 258, Rsc3, -1, 1, 1, Rsc2, -1, 1, 1,
