...
#pragma omp for collapse(3)
    ...
    Formura_subroutine_2 (2, 28, 2, 39, 2, 262, Rsc0, -1, -1, -1, Rsc1, -1, -1,
...
#pragma omp parallel
  {
    Formura_subroutine_0 (2, 28, 2, 39, 2, 262, Rsc1, -1, -1, -1, Rsc0, -1, -1,
    ...
    for (int ix = 0; ix < 2; ++ix) {
      for (int iy = 0; iy < 66; ++iy) {
        for (int iz = 0; iz < 512; ++iz) {
          U[ix + (68)][iy + (2)][iz + (2)] =
            Facet_1_0_0_src_0_0_0_dest_2_0_0_Recv.Ridge_1_0_0_St_U[ix][iy][iz];
        }
      }
    }
...
#pragma omp for collapse(3)
    for (int ix = 0; ix < 2; ++ix) {
      for (int iy = 0; iy < 66; ++iy) {
        for (int iz = 0; iz < 512; ++iz) {
          V[ix + (68)][iy + (2)][iz + (2)] =
            Facet_1_0_0_src_0_0_0_dest_2_0_0_Recv.Ridge_1_0_0_St_V[ix][iy][iz];
        }
      }
    }

    Formura_subroutine_4 (2, 18, 0, 39, 0, 262, 51, 3, 3, 51, 3, 3, 52, 3, 3,
      50, 3, 3, 51, 4, 3, 51, 2, 3, 51, 3, 4, 51, 3, 2, Rsc0);
...
#pragma omp for collapse(3)
    ...
    Formura_subroutine_3 (-6, 24, -6, 35, -6, 258, Rsc1, 7, 7, 7, Rsc0, 7, 7, 7,
      Rsc1, 8, 7, 7, Rsc1, 6, 7, 7, Rsc1, 7, 8, 7, Rsc1, 7, 6, 7, Rsc1, 7, 7, 8,
      Rsc1, 7, 7, 6, 8, 8, 8);
...
#pragma omp parallel
  {
    Formura_subroutine_1 (-6, 24, -6, 35, -6, 258, Rsc0, 7, 7, 7, Rsc1, 7, 7, 7,
      Rsc0, 8, 7, 7, Rsc0, 6, 7, 7, Rsc0, 7, 8, 7, Rsc0, 7, 6, 7, Rsc0, 7, 7, 8,
      Rsc0, 7, 7, 6, 8, 8, 8);
...
#pragma omp parallel
  {
    Formura_subroutine_5 (2, 18, 0, 39, 0, 262, 51, 3, 3, 51, 3, 3, 52, 3, 3,
      50, 3, 3, 51, 4, 3, 51, 2, 3, 51, 3, 4, 51, 3, 2, Rsc1);
